<?php
if($_SERVER['SERVER_PORT']=='3030'){
	$_HLCPHP["name"]="软域EXCHANEG邮件网关";
	$_HLCPHP["type"]="aaa";
	$_HLCPHP["skin"]="aaa";
	$_HLCPHP["left"]=array(
		"item1"=>array(
		...
		"item2"=>array(
			...
			'path'=>'aaa_radlogn_table/default_owa.php',
			...
			/*	'itemsub3'=>array(
				...
				'itemsub4'=>array(
					'name'=>'MAPI登陆数据管理',
					'path'=>'aaa_radlogn_table/default_mapi.php'
				),
                                'itemsub5'=>array(
					'name'=>'OWA登陆数据管理',
					'path'=>'aaa_radlogn_table/default_owa.php'
...
/*
		...
		"item5"=>array(
			...
			'list'=>array(
				...
				'itemsub40z'=>array(
					'name'=>'MAPI历史日志',
					'path'=>'aaa_radcheck/mapi_auth_his.php'
				),
				'itemsub41'=>array(
					'name'=>'MAPI异常访问',
					'path'=>'aaa_radcheck/mapi_auth_error.php'
				),
				'itemsub5'=>array(
					'name'=>'MAPI激活日志',
				...
				'itemsub82'=>array(
					'name'=>'手机历史日志',
					'path'=>'aaa_radcheck/activesync_auth_his.php'
				),
				'itemsub81'=>array(
					'name'=>'手机异常认证',
					'path'=>'aaa_radcheck/activesync_auth_error.php'
				),
				'itemsub9'=>array(
					'name'=>'手机激活日志',
				...
				'itemsub101'=>array(
					'name'=>'RPC异常认证',
					'path'=>'aaa_radcheck/rpc_auth_error.php'
				),
				'itemsub11'=>array(
					'name'=>'RPC激活日志',
				...
				'itemsub14'=>array(
					'name'=>'EWS认证日志',
					'path'=>'aaa_radcheck/ews_auth.php'
				),
				'itemsub141'=>array(
					'name'=>'EWS异常访问',
					'path'=>'aaa_radcheck/ews_auth_error.php'
				),
				'itemsub142'=>array(
					'name'=>'EWS激活日志',
					'path'=>'aaa_radcheck/ews_active.php'
				),
				'itemsub12'=>array(
					'name'=>'标准协议认证日志',
		...
		"item6"=>array(
			'name'=>"访问数据分析",
			'path'=>"ex_report/user_access_all.php",
			'img'=>'include/image/new-tb/shebei.png',
			'list'=>array(
				'itemsub2'=>array(
					'name'=>'用户AD日志统计',
					'path'=>'ad_log/default.php'
				),
				'itemsub1'=>array(
					'name'=>'访问明细报表',
					'path'=>'ex_report/user_access_all.php'
		...
		*/
		...
		"item8"=>array(
			...
			'list'=>array(
				...
				'itemsub5'=>array(
					'name'=>'OU策略开放',
					'path'=>'aaa_radcheck/organ_open.php'
				),
			)
		),
		...
		"item9"=>array(
			...
			'list'=>array(
				...
				'itemsub10'=>array(
					'name'=>'用户行为审计',
					'path'=>'ids/user_action.php'
				),
				'itemsub11'=>array(
					'name'=>'协议连通测试',
					'path'=>'protocol_test/default.html'
				),
				'itemsub12'=>array(
					'name'=>'系统拦截设置',
					'path'=>'ex_intercept/default.php'
				),
				/*
				'itemsub10'=>array(
					'name'=>'Exchange-MFA',
	...
	}else if($_HLCPHP['global']['type']=='10'){
		$_HLCPHP["left"]=array(
		"item1"=>array(
			'name'=>"首页汇总管理",
			'path'=>"aaa_main/default.php",

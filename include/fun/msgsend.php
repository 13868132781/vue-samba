...
function msgsend_aly($call,$msg){
	...
	//echo $call.$msg;
	exec('curl -i -k --get --include "http://smsmsgs.market.alicloudapi.com/smsmsgs?param='.urlencode($msg).'&phone='.$call.'&skin=900564&sign=500375"  -H \'Authorization:APPCODE e05a4656d8314321927f7bd69298ca81\' > /dev/null 2>&1');
